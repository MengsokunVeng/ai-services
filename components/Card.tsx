    ...
    <div className="flex w-full pl-[10px] items-center  justify-center">
      <div className=" mb-2 max-w-[95%]">
        ...
        >
          ...
          <p className="pointer-events-none block text-sm text-gray-text">
            Enhanced chatbots utilizing web search.
          </p>
        </a>
      </div>
    </div>
